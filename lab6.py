...
#       -(pow(x[0], 2)) -8*x[0]- (pow(x[1], 2))-2*x[1]-4* (pow(x[2], 2)) -112*x[2] -797.8
...
ax0.set_title('Linii urovneniya i \n traektoriay poiska \n x1,x2')
ax1.set_title('Linii urovneniya i \n traektoriay poiska \n x1,x3')
ax2.set_title('Linii urovneniya i \n traektoriay poiska \n x2,x3')
